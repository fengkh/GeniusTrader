...
本文件记录第七阶段 Checkpoint A 的离线工程基线。当前没有真实 Tushare Token，也没有完成商业授权确认，因此本阶段只完成可离线实现，不执行真实行情联网 Smoke，不把任何 Provider 写成生产正式来源。
...
无真实行情时，前端必须展示“暂无真实行情数据”或等价 `unavailable` 状态，不得展示模拟价格、随机涨跌幅、虚假分时图或虚假 K 线。
